            ...
            <section className="sm:grid grid-cols-2">
                <main className="flex flex-col h-full justify-between">
                    <div className="flex flex-col sm:items-start gap-16">
                        ...
                        <button className="flex flex-row items-center justify-center gap-3 px-8 py-4 rounded-lg text-xl bg-cyan-500 text-slate-900 hover:bg-cyan-600 transition-colors duration-300">
                            <FaRegEnvelope />
                            Me envie um e-mail
                        </button>
                    </div>
                    ...
                    <div className="flex flex-row gap-4 pt-8 ml-auto sm:ml-0">
                        <a href="#" className="flex flex-col items-center gap-2 font-normal text-sm">
